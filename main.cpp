...
{ ahash_rs,             64, 0x0,        "aHash_rs",           "aHash keyed hash function (crate `ahash`)", POOR,
    { // bad seeds:
      0x0784d071, 0x0a2ad71e, 0x0ce08894, 0x1900d979, 0x20afb6ff, 0x20c1e4a3,
      0x2c8d1b33, 0x2ef9c50f, 0x3089c558, 0x33b10ed2, 0x36be106e, 0x45ff4293,
      0x47b419b4, 0x47b4a28a, 0x4f77212c, 0x533e207d, 0x57384cca, 0x595c2873,
      0x5df5ffe9, 0x6a3b231c, 0x6ab36d60, 0x6e6e8e68, 0x6ff17e15, 0x7c08f182,
      0x7dc92434, 0x8801bed9, 0x91e17111, 0x942e78fa, 0x9fc424ba, 0xa43fe608,
      0xa9d409ba, 0xadfd91b6, 0xb0427aca, 0xb43747b2, 0xb5322f7b, 0xb5e6280e,
      0xb61ff2e5, 0xc09cc880, 0xc77ac2f7, 0xc97d5c54, 0xcfe5ca1f, 0xd2e27e1b,
      0xdd4e203f, 0xe00eedae, 0xe18ad6ce, 0xe603ded2, 0xf0578491 }
   },
{ ascon_rs,            256, 0x6A31F37D, "Ascon_rs",           "Ascon hash (crate `ascon-hash`)", POOR, {} },
{ ascona_rs,           256, 0x0A6C3BC9, "AsconA_rs",          "AsconA hash (crate `ascon-hash`)", POOR, {} },
{ blake2b512_rs,       512, 0xCCF30995, "BLAKE2b-512_rs",     "BLAKE2b-512 (crate `blake2`)", GOOD , {} },
{ blake2s256_rs,       256, 0x0AD2866D, "BLAKE2s-256_rs",     "BLAKE2s-256 (crate `blake2`)", POOR, {} },
{ blake3_rs,           256, 0x170AB674, "BLAKE3_rs",          "BLAKE3 (crate `blake3`)", POOR, {} },
{ crc32fast_rs,         32, 0x5C7DDD1F, "CRC32_rs",           "CRC32 (crate `crc32fast`)", POOR, {} },
{ fnvhash_rs,           64, 0xBF1EC520, "FNV_rs",             "Fowler-Noll-Vo hash function (crate `fnv`)", POOR, {} },
{ fxhash32_rs,          32, 0xBBE55FD6, "FxHash32",           "FxHash (FireFox hash) with 32 bits (crate `fxhash`)", POOR, {} },
{ fxhash64_rs,          64, 0x09C69C4D, "FxHash64",           "FxHash (FireFox hash) with 64 bits (crate `fxhash`)", POOR, {} },
{ hash_hasher_rs,       64, 0xFAF9F8F7, "hash_hasher_rs",     "A hasher designed to work on already hashed or hash-like data (crate `hash_hasher`)", SKIP, {} },
{ highway_rs,           64, 0x53BE18F1, "Highway_rs",         "An implementation of Google's HighwayHash (crate `highway`)", POOR, {} },
{ md5_rs,              128, 0x3008D5BF, "MD5_rs",             "MD5 algorithm (crate `md-5`)", POOR, {} },
{ ripemd128_rs,        128, 0x8477BC3A, "RIPEMD-128_rs",      "RIPEMD-128 algorithm (crate `ripemd`)", POOR, {} },
{ ripemd160_rs,        160, 0x8E643595, "RIPEMD-160_rs",      "RIPEMD-160 algorithm (crate `ripemd`)", POOR, {} },
{ ripemd256_rs,        256, 0x923C6945, "RIPEMD-256_rs",      "RIPEMD-256 algorithm (crate `ripemd`)", POOR, {} },
{ ripemd320_rs,        320, 0xF4C9CCCA, "RIPEMD-320_rs",      "RIPEMD-320 algorithm (crate `ripemd`)", GOOD, {} },
{ sha1_rs,             160, 0x6575EB18, "SHA-1_rs",           "SHA-1 algorithm (crate `sha1`)", POOR, {} },
{ sha224_rs,           224, 0x9E4E5F48, "SHA-224_rs",         "SHA-224 algorithm (crate `sha2`)", POOR, {} },
{ sha256_rs,           256, 0x11D13DB9, "SHA-256_rs",         "SHA-256 algorithm (crate `sha2`)", POOR, {} },
{ sha384_rs,           384, 0x1560ABE1, "SHA-384_rs",         "SHA-384 algorithm (crate `sha2`)", GOOD, {} },
{ sha512_rs,           512, 0x4590E90F, "SHA-512_rs",         "SHA-512 algorithm (crate `sha2`)", GOOD, {} },
{ sha512_224_rs,       224, 0x91809107, "SHA-512/224_rs",     "SHA-512 algorithm with 224-bit output (crate `sha2`)", GOOD, {} },
{ sha512_256_rs,       256, 0xEE8A194F, "SHA-512/256_rs",     "SHA-512 algorithm with 256-bit output (crate `sha2`)", GOOD, {} },
{ cshake128_rs,        128, 0x44D677A9, "CSHAKE128_rs",       "CSHAKE128 algorithm with variable-length output (128 bits for test, crate `sha3`)", GOOD, {} },
{ cshake256_rs,        256, 0x2A89CE43, "CSHAKE256_rs",       "CSHAKE256 algorithm with variable-length output (256 bits for test, crate `sha3`)", GOOD, {} },
{ keccak224_rs,        224, 0x9BAF3E77, "Keccak-224_rs",      "Keccak-224 algorithm (crate `sha3`)", POOR, {} },
{ keccak256_rs,        256, 0x674D592E, "Keccak-256_rs",      "Keccak-256 algorithm (crate `sha3`)", POOR, {} },
{ keccak256full_rs,   1600, 0xAE7C9A0E, "Keccak-256_CN_rs",   "Keccak-256 hash algorithm, SHA-3 CryptoNight with 1600 bits (crate `sha3`)", GOOD, {} },
{ keccak384_rs,        384, 0x38419F8F, "Keccak-384_rs",      "Keccak-384 algorithm (crate `sha3`)", GOOD, {} },
{ keccak512_rs,        512, 0x49B9CDBF, "Keccak-512_rs",      "Keccak-512 algorithm (crate `sha3`)", GOOD, {} },
{ sha3_224_rs,         224, 0x70FE610D, "SHA-3-224_rs",       "SHA-3 algorithm with 224-bit output (crate `sha3`)", POOR, {} },
{ sha3_256_rs,         256, 0x1D223BAC, "SHA-3-256_rs",       "SHA-3 algorithm with 256-bit output (crate `sha3`)", POOR, {} },
{ sha3_384_rs,         384, 0x3681ED26, "SHA-3-384_rs",       "SHA-3 algorithm with 384-bit output (crate `sha3`)", GOOD, {} },
{ sha3_512_rs,         512, 0xAC16C570, "SHA-3-512_rs",       "SHA-3 algorithm with 512-bit output (crate `sha3`)", GOOD, {} },
{ shake128_rs,         128, 0xA3DDDBCA, "SHAKE128_rs",        "SHAKE128 algorithm with variable-length output (128 bits for test, crate `sha3`)", GOOD, {} },
{ shake256_rs,         256, 0xEC6D6119, "SHAKE256_rs",        "SHAKE256 algorithm with variable-length output (256 bits for test, crate `sha3`)", POOR, {} },
{ turboshake128_1f_rs, 128, 0x20E54F6D, "TurboSHAKE128_rs",   "turboshake128 algorithm with variable-length output (128 bits for test, domain separation 0x1f, crate `sha3`)", POOR, {} },
{ turboshake256_1f_rs, 256, 0x954400C9, "TurboSHAKE256_rs",   "turboshake256 algorithm with variable-length output (256 bits for test, domain separation 0x1f, crate `sha3`)", POOR, {} },
{ twox_xxhash32_rs,     32, 0xBA88B743, "xxHash32_twox_rs",   "32-bit xxHash implementation (crate `twox_hash`)", GOOD, {} },
{ twox_xxhash64_rs,     64, 0x024B7CF4, "xxHash64_twox_rs",   "64-bit xxHash implementation (crate `twox_hash`)", GOOD, {} },
{ siphash13_rs,         64, 0x8936B193, "SipHash_1-3_rs",     "SipHash with 1 round and 3 finalization rounds (crate `siphasher`)", GOOD, {} },
...
{ xxhash64_rs,          64, 0x024B7CF4, "xxHash64_rs",        "64-bit xxHash implementation (crate `xxhash-rust`)", GOOD, {} },
#endif
};
