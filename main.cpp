...
{ fxhash32_rs,          32, 0xBBE55FD6, "FxHash32",           "FxHash (FireFox hash) with 32 bits (crate `fxhash`)", GOOD, {} },
{ fxhash64_rs,          64, 0x09C69C4D, "FxHash64",           "FxHash (FireFox hash) with 64 bits (crate `fxhash`)", GOOD, {} },
...
{ shake128_rs,         128, 0xDDA4FB6B, "SHAKE128_rs",        "SHAKE128 algorithm with variable-length output (128 bits for test, crate `sha3`)", GOOD, {} },
